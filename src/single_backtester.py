...
def ai_hedge_fund_back_test():
    ...
    # print(df)
    # df.to_csv("Before_error_" + tickers[0] + "_" + selected_analysts[0] + "_" + user_start_date + "_to_" + user_end_date +".csv", index=False)

    # initial_price = df.loc[df['Shares'] != 0, 'Price'].iloc[0]
    ...
    print(updated_portfolio_summary)
    print(type(updated_portfolio_summary))
...
def new_ai_hedge_fund_back_test():
